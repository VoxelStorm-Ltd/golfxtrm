...
void world::update_vbo() {
  ...
  for(double i = 0; i < 360; i += 2) {
    ...
    vbodata.push_back(std::cos((i + thiswidth) * M_PI / 180) * horizondistance / 4);
    vbodata.push_back(-2);
    vbodata.push_back(std::sin((i + thiswidth) * M_PI / 180) * horizondistance / 4);
    vbodata.push_back(std::cos((i            ) * M_PI / 180) * horizondistance / 4);
    vbodata.push_back(thisheight - 2);
    vbodata.push_back(std::sin((i            ) * M_PI / 180) * horizondistance / 4);
    vbodata.push_back(std::cos((i - thiswidth) * M_PI / 180) * horizondistance / 4);
    vbodata.push_back(-2);
    vbodata.push_back(std::sin((i - thiswidth) * M_PI / 180) * horizondistance / 4);
    vbodata_n.push_back(-std::cos((i + thiswidth) * M_PI / 180));
    vbodata_n.push_back(1);
    vbodata_n.push_back(-std::sin((i + thiswidth) * M_PI / 180));
    vbodata_n.push_back(-std::cos((i + thiswidth) * M_PI / 180));
    vbodata_n.push_back(1);
    vbodata_n.push_back(-std::sin((i + thiswidth) * M_PI / 180));
    vbodata_n.push_back(-std::cos((i + thiswidth) * M_PI / 180));
